        ...
        <div class="row">
                ...
                <div class="about_img_box">
                    ...
                    <div class="support_img">
                        ...
                        <div class="item_card">
                            ...
                            <h3>24/7 Support</h3>
                            <p>24/7 support available anytime, anywhere.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 wow fadeInRight" data-wow-duration="1s">
                <div class="section_heading pt_35">
                    <h3>About Company</h3>
                    <h2>Global IT Partner Delivering Excellence and Expertise</h2>
                </div>
                <div class="about_content">
                    <p>Established in 2023, Yava Tech is headquartered in Houston, TX, USA, and India. We are a
                        preferred partner to global corporations, offering expertise in managed programs and subcontract
                        management to drive innovation and success.</p>
                    <div class="grid_item">
                        <div class="left">
                            <div class="experience">
                                ...
                                <p>2 Years of Consulting <span>Experience</span></p>
                            </div>
                            <ul>
                                <li>Headquarters in Houston, TX, USA, and India.</li>
                                <li>Collaborates with Synechrone, Nagarro, Dexian, and others.</li>
                                <li>Specializes in managed programs and subcontract management.</li>
                            </ul>
...
<!--==============================
        WHY CHOOSE START
    ===============================-->
<section class="testimonial pt_115 xs_pt_75 pb_120 xs_pb_80" style="background: url(images/testi_bg.jpg);">
    <div class="container">
        <div class="row">
            <div class="col-xl-8 m-auto">
                <div class="section_heading pb_20">
                    <h3>Why Choose Us<span class="text_stroke">Why Choose Us</span></h3>
                    <h2>Why Choose Us</h2>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xl-12 wow fadeInUp" data-wow-duration="1s">
                <div class="privacy_policy_text">
                    <ol>
                        <li><strong>Strategic Placement:</strong> We ensure that the right candidates are in place to
                            meet our clients' immediate needs.</li>
                        <li><strong>Talent Readiness:</strong> Our bench of skilled professionals is ready to be
                            deployed at a moment's notice.</li>
                        <li><strong>High Reliability:</strong> We maintain a <strong>low no-show ratio</strong> by
                            thoroughly vetting and confirming candidate commitments.</li>
                        <li><strong>Effective Screening:</strong> Our rigorous screening processes ensure high candidate
                            engagement and reliability.</li>
                        <li><strong>Quick Turnaround:</strong> We minimize downtime by rapidly deploying pre-qualified
                            candidates.</li>
                        <li><strong>Comprehensive Understanding:</strong> We gain a thorough understanding of our
                            clients' functional environments and business goals.</li>
                        <li><strong>Cost Efficiency:</strong> Optimize your budget with our ready-to-hire talent pool.
                        </li>
                        <li><strong>Professional Team:</strong> A team of professional recruiters supports our candidate
                            search, qualification, and selection processes.</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xl-8 m-auto">
                <div class="section_heading">
                    <h3>Achievements <span class="text_stroke">Achievements</span></h3>
        ...
        <div class="row">
            <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-duration="1s">
                <div class="achievement_item">
                    <div class="icon">
                        <span><img src="images/achiv-1.png" alt="icon" class="img-fluid w-100"></span>
                    </div>
                    <h4><span class="counter">568</span>+</h4>
            ...
            <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-duration="1s">
                <div class="achievement_item">
                    <div class="icon">
                        <span><img src="images/achiv-2.png" alt="icon" class="img-fluid w-100"></span>
                    </div>
                    <h4><span class="counter">2569</span>+</h4>
            ...
            <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-duration="1s">
                <div class="achievement_item">
                    <div class="icon">
                        <span><img src="images/achiv-3.png" alt="icon" class="img-fluid w-100"></span>
                    </div>
                    <h4><span class="counter">256</span></h4>
            ...
            <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-duration="1s">
                <div class="achievement_item">
                    <div class="icon">
                        <span><img src="images/achiv-4.png" alt="icon" class="img-fluid w-100"></span>
                    </div>
...
<!--==============================
        VIDEO START
    ===============================-->
<section class="home_2_video mt_100 xs_mt_60" style="background: url(images/home2_videobg.jpg) no-repeat center/cover;">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10  wow fadeInUp" data-wow-duration="1s">
                    <div class="home_2_video_content">
                        ...
                        <h2>Elevate Your Business with Our Expert Services!</h2>
                        <a class="common_btn" href="about">Discover More</a>
                    </div>
                </div>
            </div>
        </div>
...
<section class="team pt_115 xs_pt_75 pb_120 xs_pb_80">
    <div class="container">
        <div class="row">
            <div class="col-xl-8">
                <div class="section_heading pb_20">
                    <h3>Our Team<span class="text_stroke">Our Team</span></h3>
        ...
        <div class="row team_slider">
            <div class="col-xl-3 wow fadeInUp" data-wow-duration="1s">
                <div class="single_team">
                    ...
                    <div class="text">
                        <a href='team_details.html'>MD. Fardin Jaman</a>
                        <p>UI/UX Designer</p>
                    </div>
                    <ul>
        ...
        <div class="row home_2_team_slider">
            <div class="col-lg-4 wow fadeInUp" data-wow-duration="1s">
                <div class="home_2_single_team">
                    ...
                    <p>Yava Tech's expertise in managed programs has been invaluable in streamlining our operations.</p>
            ...
            <div class="col-lg-4 wow fadeInUp" data-wow-duration="1s">
                <div class="home_2_single_team">
                    ...
                    <p>As a trusted partner, Yava Tech consistently delivers exceptional results for our subcontract
                        management needs.</p>
                    <div class="item_bottom">
                        <div class="text">
                            <h4>Emily R.</h4>
                            <p> – HR Manager, Global Corp</p>
                        </div>
                        <ul>
                            <li><i class="fas fa-star"></i></li>
                            <li><i class="fas fa-star"></i></li>
            ...
            <div class="col-lg-4 wow fadeInUp" data-wow-duration="1s">
                <div class="home_2_single_team">
                    ...
                    <p>Yava Tech’s reliability and professionalism make them a vital part of our global collaboration.
                    </p>
                    <div class="item_bottom">
                        <div class="text">
                            <h4>Mark T.</h4>
                            <p> – Project Lead, Synechrone</p>
                        </div>
                        <ul>
                            <li><i class="fas fa-star"></i></li>
                            <li><i class="fas fa-star"></i></li>
            ...
            <div class="col-lg-4 wow fadeInUp" data-wow-duration="1s">
                <div class="home_2_single_team">
                    ...
                    <p>Partnering with Yava Tech has enhanced our efficiency and strengthened our global operations
                        significantly.</p>
                    <div class="item_bottom">
                        <div class="text">
                            <h4>Sophia L.</h4>
